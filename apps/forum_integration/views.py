...
class CustomForumIndexView(BaseIndexView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Get accurate statistics using the DI container service
...
# Rich Forum Post Views - REMOVED
# RichForumPost feature disabled - forum is now fully headless (React + API)
# All forum content creation/editing happens via React components consuming REST API
# See frontend/src/pages/Forum*.jsx and /api/v1/forums/* endpoints in apps/api/forum_api.py