# Generated by Django 5.2.4 on 2025-07-06 03:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievement_type', models.CharField(choices=[('course', 'Course Completion'), ('exercise', 'Exercise Solving'), ('streak', 'Learning Streak'), ('social', 'Social Interaction'), ('contribution', 'Community Contribution')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty_level', models.CharField(choices=[('beginner', 'Beginner Friendly'), ('intermediate', 'Intermediate'), ('advanced', 'Advanced')], default='intermediate', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_programming_languages', models.CharField(blank=True, max_length=200)),
